...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 py-10 px-4">
      <motion.div
          ...
          <div className="relative p-8 md:p-12 space-y-12">
            ...
            <motion.section variants={sectionVariants} className="group">
              ...
              >
                ...
                />
                <motion.h2 className="text-2xl md:text-3xl font-semibold text-blue-600 mb-4 flex items-center" transition={{ duration: 0.2 }}>
                  <motion.span
            ...
            <motion.section variants={sectionVariants} className="group">
              ...
              >
                ...
                />
                <motion.h2 className="text-2xl md:text-3xl font-semibold text-cyan-600 mb-4 flex items-center" transition={{ duration: 0.2 }}>
                  <motion.span
                    className="mr-3 text-3xl"
            ...
            <motion.section variants={sectionVariants} className="group">
              ...
              >
                ...
                />
                <motion.h2 className="text-2xl md:text-3xl font-semibold text-teal-600 mb-4 flex items-center" transition={{ duration: 0.2 }}>
                  <motion.span
                    className="mr-3 text-3xl"
                    animate={{ y: [0, -5, 0] }}
                    transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
