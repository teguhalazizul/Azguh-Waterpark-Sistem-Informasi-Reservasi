                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <p className="flex items-center gap-2">
                      ...
                      <span className="font-medium">Berlaku:</span> {ticket.validity}
                    </p>
                  </div>
                  
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                      <span className="text-2xl font-bold text-blue-700">{ticket.price}</span>
                    </div>
                    <button
                      onClick={() => navigate("/order", { state: { ticket } })}
                      className="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg font-medium"
                    >
                      Pesan
                    </button>
                  </div>
